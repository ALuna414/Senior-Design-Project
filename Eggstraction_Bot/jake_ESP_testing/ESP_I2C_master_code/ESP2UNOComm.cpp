...
ESP2UNOComm::IRColor ESP2UNOComm::getLeftIRSensor()
{
...
ESP2UNOComm::IRColor ESP2UNOComm::getRightIRSensor()
{
...
void ESP2UNOComm::printRXData()
{
  ...
  Serial.print("power_low:\t"); Serial.println((RX_data.power_low ? "true" : "false"));
}
...
void ESP2UNOComm::printTXData()
{
  ...
  Serial.println("grabber_signal:\t"); Serial.println((TX_data.grabber_signal ? "true" : "false"));
