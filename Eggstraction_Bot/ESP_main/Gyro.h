...
public:
  ...
  float displacement = 0;  // net displacement from starting angle
  ...
  float relativeAngle(float heading);
  float relativeAngle(float reference, float heading);
  float angle();  // returns current angle in degrees
};
